...
public class V_stockProdConfig extends javax.swing.JDialog {
    ...
    D_products dataP = new D_products();
    ...
    public void receiveData(E_product p) {
        product = p;
        lblNameProd.setText(String.valueOf(p.getProductName()));
        lblOldStock.setText(String.valueOf(p.getStock()));
    }
    ...
    private void initComponents() {
        ...
        spnNewStock = new javax.swing.JSpinner();
        ...
        lblOldStock = new javax.swing.JLabel();
        ...
        spnNewStock.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N

        btnAdd.setBackground(new java.awt.Color(0, 153, 0));
        btnAdd.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N
        btnAdd.setForeground(new java.awt.Color(255, 255, 255));
        btnAdd.setText("Aplicar");
        ...
        txtPrice.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(spnNewStock, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel6.setText("Existencias Actuales:");

        lblOldStock.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N
        lblOldStock.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblOldStock.setText("0101");
        lblOldStock.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel7.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N
        jLabel7.setText("Producto:");

        lblNameProd.setFont(new java.awt.Font("MADE TOMMY", 1, 14)); // NOI18N
        lblNameProd.setText(" ");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblOldStock, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        pph.setOld_Stock(Integer.parseInt(lblOldStock.getText()));
        pph.setNew_Stock((Integer) spnNewStock.getValue());
        pph.setPrice(Double.parseDouble(txtPrice.getText()));
        pph.setIdProduct(product);
        
        if (businessPPH.B_insertPPH(pph)) {
            dataP.addStock(product, pph.getNew_Stock());
            V_productsCrud.btnRefresh.doClick();
            this.dispose();
        }
...
//    }
    ...
    private javax.swing.JLabel lblOldStock;
    private javax.swing.JSpinner spnNewStock;
